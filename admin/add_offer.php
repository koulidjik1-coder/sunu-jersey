...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_offer'])) {
    ...
    addOffer($pdo, $_POST['name'], $_POST['description'], $image_path, $background_path, $_POST['link_product_id'] ?: null);
            ...
            <div class="form-group">
                ...
                <select name="link_product_id">
                    ...
                    <?php foreach ($products as $product): ?>
                        <option value="<?php echo $product['id']; ?>"><?php echo htmlspecialchars($product['name']); ?> - <?php echo htmlspecialchars($product['team']); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            
            <button type="submit" name="add_offer" class="btn-submit">Ajouter l'offre</button>
        </form>
    </div>
</body>
</html>
